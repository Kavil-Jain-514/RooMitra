...
const LandingPage = () => {
    ...
    const fullTagline = "Yoour perfect MITRA is just a click away!";
    useEffect(() => {
        let i = 0;
        const typingSpeed = 50; // Time interval for typing effect
        const typingInterval = setInterval(() => {
            if (i < fullTagline.length - 1) {
                setTagline((prev) => prev + fullTagline[i]);
                i++;
            } else {
        ...
        }, 3000); // Make logo disappear after tagline disappears
    ...
    return (
        <div className="bg-gray-100">
            <div className={`fixed inset-0 flex flex-col items-center justify-center transition-all duration-1000 ease-in-out ${animateLogo ? 'opacity-100' : 'opacity-0 translate-y-[-100%]'}`}>
                <img src={logo} alt="RooMitra Logo" className="w-60 h-60" />
                {showTagline && <h2 className="text-2xl font-bold text-blue-600">{tagline}</h2>}
            </div>
            {/* Header */}
            {!animateLogo && <Header />}
            ...
            {!animateLogo && (
                <main>
                    ...
                    {showSelection && (
                        <section className="text-center py-20">
                            ...
                            <p className="text-lg text-gray-600 mb-6">
                                Let us help you find your perfect living situation. Choose your path below:
                            </p>
                    ...
                    <section className="text-center py-20">
                        ...
                        <img src={matchedPeoplePhoto} alt="Visual representation" className="mx-auto w-1/4 rounded-lg shadow-lg" />
                    </section>
                    ...
                    <section id="features" className="py-20 bg-white">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
                            <div className="p-6 bg-gray-200 rounded-lg shadow-lg flex flex-col items-center text-center">
                                <img src={roomMateMatchingPhoto} alt="Room Matching" className="w-32 h-32 mb-4 rounded-lg" />
                            ...
                            <div className="p-6 bg-gray-200 rounded-lg shadow-lg flex flex-col items-center text-center">
                                <img src={communityBuildingPhoto} alt="Community Building" className="w-32 h-32 mb-4 rounded-lg" />
                                <h3 className="font-bold text-xl mb-2">Community Building</h3>
                                <p className="text-gray-700">Connect with like-minded individuals through groups and shared interests.</p>
                            </div>
                            <div className="p-6 bg-gray-200 rounded-lg shadow-lg flex flex-col items-center text-center">
                                <img src={furnitureTradingPhoto} alt="Furniture Trading" className="w-32 h-32 mb-4 rounded-lg" />
                                <h3 className="font-bold text-xl mb-2">Furniture Trading</h3>
                                <p className="text-gray-700">Easily buy, sell, or exchange furniture with fellow users within the platform.</p>
                            </div>
                        </div>
                    </section>
